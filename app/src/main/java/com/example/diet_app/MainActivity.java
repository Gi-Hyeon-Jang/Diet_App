...
//        placeDBManager.insertFood("상록원1층","삼겹살김치철판",560,5500);
//        placeDBManager.insertFood("상록원1층","데리야끼치킨솥밥",420,5000);
//        placeDBManager.insertPlace("상록원2층");
//        placeDBManager.insertFood("상록원2층","오늘의 덮밥",440,4500);
//        placeDBManager.insertFood("상록원2층","국밥",490,5800);
//        placeDBManager.insertFood("상록원2층","얼큰국밥",500,6300);
//        placeDBManager.insertFood("상록원2층","돈가스",540,6000);
//        placeDBManager.insertPlace("상록원3층");
//        placeDBManager.insertFood("상록원3층","오늘의 메뉴",610,7000);
...
//        placeDBManager.insertPlace("PAUL BASSET");
//        placeDBManager.insertFood("PAUL BASSET","아메리카노",4,1500);
//        placeDBManager.insertFood("PAUL BASSET","카페라떼",110,2500);
//        placeDBManager.insertFood("PAUL BASSET","초코라떼",155,3000);
//        placeDBManager.insertFood("PAUL BASSET","녹차라뗴",178,3000);
//        placeDBManager.insertFood("PAUL BASSET","카페모카",290,3000);
//        placeDBManager.insertFood("PAUL BASSET","밀크티",160,3000);
//        placeDBManager.insertPlace("가든쿡");
//        placeDBManager.insertFood("가든쿡","알리오올리오",402,6000);
//        placeDBManager.insertFood("가든쿡","까르보나라",384,6500);
//        placeDBManager.insertFood("가든쿡","미트소스스파게티",380,7000);
//        placeDBManager.insertFood("가든쿡","명란크림파스타",480,7500);
//        placeDBManager.insertFood("가든쿡","베이컨김치볶음밥",350,6500);
//        placeDBManager.insertFood("가든쿡","시푸드로제리조또",565,8000);
//        placeDBManager.insertPlace("가온누리");
//        placeDBManager.insertFood("가온누리","아메리카노",4,2300);
//        placeDBManager.insertFood("가온누리","카페라떼",110,2600);
//        placeDBManager.insertFood("가온누리","아이스티",260,2700);
//        placeDBManager.insertFood("가온누리","녹차라떼",178,3000);
//        placeDBManager.insertFood("가온누리","카푸치노",110,2600);
//        placeDBManager.insertFood("가온누리","레몬에이드",117,3000);
//        placeDBManager.insertPlace("블루포트");
//        placeDBManager.insertFood("블루포트","아메리카노",4,2500);
//        placeDBManager.insertFood("블루포트","헤이즐넛",90,3100);
//        placeDBManager.insertFood("블루포트","카라멜마끼야또",190,3900);
//        placeDBManager.insertFood("블루포트","조리퐁라떼",160,4100);
//        placeDBManager.insertFood("블루포트","타로버블티",230,4300);
//        placeDBManager.insertFood("블루포트","요거트",277,3900);
//        placeDBManager.insertFood("블루포트","과일쥬스",277,4200);
